...
import com.lowes.bankingapp.model.Type;
...
public class BankingAppMain {
    ...
    static {
        try {
            accService = new AccountServiceTreeMapImpl();
    ...
    public static void main(String[] args) throws AccountException, IOException, InterruptedException, SQLException {
