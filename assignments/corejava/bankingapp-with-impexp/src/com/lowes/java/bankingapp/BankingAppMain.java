        ...
        do {
            ...
            switch (choice) {
                ...
                case 6:
                    ...
                    int res1 = accService.balanceAccount(100000.00);
                    ...
                    TreeMap<String, Integer> value = accService.getAccountsByType();
                    ...
                    List<Map.Entry<String, Integer>> list = accService.getAccountsByTypeSorted();
